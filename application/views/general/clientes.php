<!--sub-heard-part-->
								  ...
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
													...
													<h3 class="inner-tittle two">Clientes <button type="button" class="btn btn-primary btn-flat btn-pri btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Cliente</button></h3>
																...
																<table class="table"> 
																	...
																	<tbody> 
																		<tr class="active">
																			...
																			<td>Av. San Miguel</td> 
																			<td>Elaboración de alimento para animales</td> 
																			<td>Activo</td>
																			<td>
